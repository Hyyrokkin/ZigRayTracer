...
pub fn build(b: *std.Build) void {
    ...
    //const mod = b.addModule("FirstRealZigTest", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "FirstRealZigTest" is the name you will use in your source code to
                // import this module (e.g. `@import("FirstRealZigTest")`). The name is
